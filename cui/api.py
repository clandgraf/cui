...
with core_api_ns(globals()) as core_api:
    ...
    core_api('new_window_set',         'C-w 5 2')
    core_api('has_window_set')
    core_api('delete_window_set',      'C-w 5 0')
    core_api('delete_window_set_by_name')
    core_api('next_window_set',        'C-w 5 n')
    ...
    core_api('select_next_window',     'C-w n')
    core_api('select_previous_window', 'C-w p')
    ...
    core_api('delete_all_windows',     'C-w 1')
    core_api('delete_selected_window', 'C-w 0')
